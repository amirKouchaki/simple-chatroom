...
onMounted(() => {
    ...
    autoAnimate(dropdown.value); // auto-animate initialization
});
</script>
...
.message-bubble {
    background-color: #dcf8c6; /* Telegram light green */
